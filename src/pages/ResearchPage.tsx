            ...
            <section className="pt-32 pb-16 bg-gradient-subtle">
                <div className="container mx-auto px-6">
                    ...
                    <p className="mt-6 text-xl text-muted-foreground max-w-3xl">
                        In-depth analysis and reports on critical issues at the intersection of democracy, technology, and national security.
                    </p>
                </div>
            </section>
            ...
            <section className="py-16 bg-background">
                <div className="container mx-auto px-6">
                    ...
                    <div className="bg-card border border-border p-8 mb-8">
                        <h3 className="font-display text-2xl text-foreground mb-4">America First Investment Policy</h3>
                        <p className="text-muted-foreground mb-6">
                            Our analysis of the White House Executive Order and recommended next steps for implementing America First investment priorities that protect national security while promoting economic growth.
                        </p>
                        ...
                        {researchReports.slice(1).map((report, index) => (
                            ...
                            >
                                <div className="flex items-start gap-4 mb-4">
                                    ...
                                    <div>
                                        <span className="text-gold text-sm uppercase tracking-wide">{report.subtitle}</span>
                                        <h3 className="font-display text-xl text-foreground mt-1">{report.title}</h3>
                                    </div>
                                </div>
                                <p className="text-muted-foreground text-sm mb-6">{report.description}</p>
