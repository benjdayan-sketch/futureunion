      ...
      <section className="pt-32 pb-16 bg-gradient-subtle">
        <div className="container mx-auto px-6">
          ...
          <span className="text-gold font-semibold uppercase tracking-widest text-sm">
            <EditableText name="veteran.hero.label" defaultContent="Human Capital" />
          </span>
          <h1 className="mt-4 font-display text-4xl md:text-5xl lg:text-6xl text-foreground tracking-wide">
            <EditableText name="veteran.hero.title" defaultContent="Veterans Transparency Index 2025" />
          </h1>
          <p className="mt-4 text-2xl text-gold font-semibold italic">
            <EditableText name="veteran.hero.subtitle" defaultContent='"The Definitive Transparency Ranking."' />
          </p>
          <p className="mt-6 text-xl text-muted-foreground max-w-3xl">
            <EditableText name="veteran.hero.description" multiline defaultContent="We honor the 30 companies that go beyond marketing placards. Our 4th edition is the definitive transparency ranking designed to highlight the companies providing transparent, high-retention career paths for our transitioning military community." />
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl">
            <h2 className="font-display text-3xl md:text-4xl text-foreground tracking-wide mb-8">
              <EditableText name="veteran.content.title" defaultContent="Actions, Not Slogans" />
            </h2>

            <div className="space-y-6 text-muted-foreground leading-relaxed mb-12">
              <p className="text-lg text-foreground font-medium">
                <EditableText name="veteran.content.quote" defaultContent='"The software is code. The hardware is steel. The driver is talent."' />
              </p>
            </div>

            <div className="space-y-6 text-muted-foreground leading-relaxed mb-12">
              <p>
                <EditableText name="veteran.content.p1" multiline defaultContent='We set out to create a listing of the very best private sector companies employing veterans. We wanted a list where voluntary self-reporting does not confer an honorary presumption of inclusion akin to a "gold star" for participation, instead the metric should be public disclosure, transparent for all to review. Our index is an attempt to identify, elevate, and recognize only the truly notable veteran-hiring companies that distinguish themselves beyond that of their peers.' />
              </p>

              <p>
                <EditableText name="veteran.content.p2" multiline defaultContent="That is why we are proud to announce our third annual Top Veteran Employers' ranking that highlights the private sector companies that both elevate veterans and provide statistics to back up employers' actions. There is much more to do, but our goal remains the same, to democratize the success and achievement of the companies that go beyond their peers in helping veterans reach their potential." />
              </p>

              <p>
                <EditableText name="veteran.content.p3" multiline defaultContent="In our ranking, Future Union decided to take a different approach to other evaluators. We started by evaluating more than 1,000 of the largest employers, evaluating them on an equal baseline methodological framework that was intended to be distinctly different from other private, self-reported survey-based methodologies. We live in a world of competition, why not bring it to rankings on transparency and action?" />
              </p>

              <p>
                <EditableText name="veteran.content.p4" multiline defaultContent="While our list could have been far longer, and many companies came close to making the list, we wanted a tight, consolidated view of the top employers and competition for our 30 honorees, instead of a broad list." />
              </p>

              <p>
                <EditableText name="veteran.content.p5" multiline defaultContent="Future Union is proud to announce a list of veteran employers that adds a transparency element to our systematic, rigorous quantitative-ranking methodology conducted on year-end 2023 regulatory filings and other published corporate reports. Thus, our evaluation combines published metrics with firm-specific, transparency elements. Our ranking is editorially-independent and serves to highlight the best corporate efforts to recruit, teach, and empower current and former service members, spouses, and their families with certifiable data supporting action." />
              </p>
            </div>

            <h3 className="font-display text-2xl text-foreground tracking-wide mb-8">
              <EditableText name="veteran.honorees.title" defaultContent="The following are the honorees of our 4th annual top-tier employers for veterans:" />
            </h3>
          </div>
          ...
          <div className="max-w-4xl">
            ...
            <p className="text-muted-foreground mb-4">
              <EditableText name="veteran.policy.intro" defaultContent="Thus, our policy recommendations for public (and private) employers to be competitive on future rankings are:" />
            </p>

            <ul className="space-y-3 text-muted-foreground list-disc list-inside">
              <li><EditableText name="veteran.policy.li1" multiline defaultContent="Detailed, veteran-specific breakouts of data with specific historical trends and a section dedicated to veterans." /></li>
              <li><EditableText name="veteran.policy.li2" multiline defaultContent="Identification of veteran-specific Employee Resource Groups or Business Resource Groups and allies, as well as the number of members as a percentage of total employees." /></li>
              <li><EditableText name="veteran.policy.li3" multiline defaultContent="Retention rates of veterans in relation to both veteran and total employee counts." /></li>
              <li><EditableText name="veteran.policy.li4" multiline defaultContent="Disclosure of the dollar amount of annual grants and/or donations." /></li>
              <li><EditableText name="veteran.policy.li5" multiline defaultContent="Disclosure of events hosted throughout the year which are designed to identify high achieving veteran successes, both sponsored and internally developed." /></li>
              <li><EditableText name="veteran.policy.li6" multiline defaultContent="Programs available and specifically designed for veterans." /></li>
            </ul>
          </div>
        </div>
      </section>
