      ...
      <div className="relative z-10 container mx-auto px-6 text-center">
        ...
        <div className="animate-fade-up opacity-0">
          <h1 className="font-display text-5xl sm:text-6xl md:text-7xl lg:text-8xl tracking-wide text-foreground inline-flex items-center justify-center">
            <span><EditableText name="home.hero.title1" defaultContent="FUTURE" /></span>
            <span className="w-4 md:w-6 h-1 bg-gold mx-1 md:mx-2"></span>
            <span><EditableText name="home.hero.title2" defaultContent="UNION" /></span>
          </h1>
        </div>
        ...
        <h2 className="mt-6 md:mt-8 font-display text-2xl md:text-3xl lg:text-4xl text-foreground uppercase tracking-wider animate-fade-up opacity-0 delay-100">
          <EditableText
            name="home.hero.tagline"
            defaultContent="Securing the Next Allied Century."
          />
        </h2>

        <div className="mt-6 md:mt-8 text-lg md:text-xl text-muted-foreground max-w-4xl mx-auto font-light animate-fade-up opacity-0 delay-200 leading-relaxed">
          <EditableText
            name="home.hero.description"
            multiline={true}
            defaultContent="At a pivotal geopolitical inflection point, Future Union serves as the premier nexus for convening the allied collective. We serve as the auditor and architect of a nexus of allied capital and technological innovation."
          />
        </div>

        <div className="mt-12 animate-fade-up opacity-0 delay-400">
          <EditableLink
            name="home.hero.cta.text"
            linkName="home.hero.cta.href"
            defaultContent="Join the Mission"
            defaultHref="#mission"
